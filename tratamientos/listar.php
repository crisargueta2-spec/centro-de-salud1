...
if ($q !== '') {
    ...
    // Solo comparar fechas si el query ES una fecha válida
...
<div class="topbar">
  ...
  <div class="d-flex gap-2">
    <!-- 🔍 Búsqueda con rutas absolutas (Render-safe) -->
    ...
    <?php if ($canWrite): ?>
      <a href="/tratamientos/crear.php" class="btn btn-primary">
...
<div class="table-card mt-3">
      ...
      <tbody>
        <?php foreach ($rows as $r): ?>
          <tr>
            ...
            <td class="no-print">
              <?php if ($canWrite): ?>
                <a href="/tratamientos/editar.php?id=<?= $r['id'] ?>" class="btn btn-sm btn-outline-secondary">Editar</a>
                <a href="/tratamientos/eliminar.php?id=<?= $r['id'] ?>"
  ...
  <!-- 🎚️ Filtros rápidos abajo (rutas absolutas) -->
