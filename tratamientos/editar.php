...
$id  = (int)($_GET['id'] ?? 0);
$st  = $conn->prepare("SELECT * FROM tratamientos WHERE id=?");
$st->execute([$id]);
...
if ($_SERVER['REQUEST_METHOD']==='POST') {
  ...
  $up = $conn->prepare("UPDATE tratamientos
...
<div class="form-page">
  <div class="form-card">
    ...
    <div class="form-card-body">
      <form method="POST" action="tratamientos/editar.php?id=<?= $t['id'] ?>" class="row g-3">
        <?php csrf_field(); ?>
