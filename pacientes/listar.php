  ...
  <div class="d-flex gap-2">
    <form class="d-flex gap-2" method="get" action="pacientes/listar.php">
      <input class="form-control" style="min-width:260px" type="search" name="q"
             placeholder="Buscar por nombre, motivo, fecha, edad..."
    ...
    <?php if (in_array($rol, ['admin', 'secretaria'])): ?>
      <a class="btn btn-primary" href="pacientes/crear.php">
...
<div class="small-muted mb-2">
  Se muestran por defecto los pacientes <strong>ingresados hoy</strong>.
</div>
