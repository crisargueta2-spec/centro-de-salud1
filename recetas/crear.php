...
$trats     = [];
if ($paciente_id) {
  $st = $conn->prepare("SELECT id, diagnostico, estado FROM tratamientos WHERE paciente_id=? ORDER BY id DESC");
...
if ($_SERVER['REQUEST_METHOD']==='POST') {
  ...
  // Insert cabecera receta
  $ins = $conn->prepare("INSERT INTO recetas (paciente_id,tratamiento_id,medico_id,fecha_emision,observaciones)
                         VALUES (?,?,?,?,?)");
  ...
  $it = $conn->prepare("INSERT INTO receta_items (receta_id, medicamento, presentacion, dosis, frecuencia, via, duracion, indicaciones)
                        VALUES (?,?,?,?,?,?,?,?)");
  ...
  header('Location: ../historial/ficha.php?id='.$paciente_id.'#recetas'); exit;
}
    ...
    <div class="form-card-body">
      <form method="POST" action="recetas/crear.php" class="row g-3">
          ...
          <?php for($i=0;$i<6;$i++): ?>
            <div class="row g-2 align-items-end mb-1">
              ...
              <div class="col-lg-2">
                ...
                <input class="form-control" name="presentacion[]">
              </div>
              <div class="col-lg-2">
              ...
              <div class="col-12">
                ...
                <input class="form-control" name="indicaciones[]">
              </div>
            </div>
        ...
        <div class="col-12 d-flex gap-2 justify-content-end">
          <a href="<?= $paciente_id ? 'historial/ficha.php?id='.$paciente_id.'#recetas' : 'recetas/listar.php' ?>" class="btn btn-secondary">Cancelar</a>
